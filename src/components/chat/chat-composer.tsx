                ...
                <div className="flex justify-between items-center mt-2">
                    ...
                    <div className="flex items-center gap-2">
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="w-[170px] bg-white dark:bg-popover z-50 rounded-xl shadow-lg border border-gray-200 dark:border-border p-1.5 flex flex-col gap-1">
